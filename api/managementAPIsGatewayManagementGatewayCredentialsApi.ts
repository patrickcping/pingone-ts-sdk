...
export enum ManagementAPIsGatewayManagementGatewayCredentialsApiApiKeys {
}

export class ManagementAPIsGatewayManagementGatewayCredentialsApi {
    ...
    public setApiKey(key: ManagementAPIsGatewayManagementGatewayCredentialsApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsGatewayManagementGatewayCredentialsApiApiKeys[key]].apiKey = value;
    }
