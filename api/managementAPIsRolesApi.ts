...
export enum ManagementAPIsRolesApiApiKeys {
}

export class ManagementAPIsRolesApi {
    ...
    public setApiKey(key: ManagementAPIsRolesApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsRolesApiApiKeys[key]].apiKey = value;
    }
