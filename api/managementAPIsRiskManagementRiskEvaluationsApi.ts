...
export enum ManagementAPIsRiskManagementRiskEvaluationsApiApiKeys {
}

export class ManagementAPIsRiskManagementRiskEvaluationsApi {
    ...
    public setApiKey(key: ManagementAPIsRiskManagementRiskEvaluationsApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsRiskManagementRiskEvaluationsApiApiKeys[key]].apiKey = value;
    }
