...
export enum ManagementAPIsApplicationsApplicationSecretApiApiKeys {
}

export class ManagementAPIsApplicationsApplicationSecretApi {
    ...
    public setApiKey(key: ManagementAPIsApplicationsApplicationSecretApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsApplicationsApplicationSecretApiApiKeys[key]].apiKey = value;
    }
