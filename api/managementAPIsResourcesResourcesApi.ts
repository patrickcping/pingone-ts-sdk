...
export enum ManagementAPIsResourcesResourcesApiApiKeys {
}

export class ManagementAPIsResourcesResourcesApi {
    ...
    public setApiKey(key: ManagementAPIsResourcesResourcesApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsResourcesResourcesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param resourceID 
     */
    public async readOneResource (envID: string, resourceID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Resource;  }> {
        const localVarPath = this.basePath + '/v1/environments/{envID}/resources/{resourceID}'
            .replace('{' + 'envID' + '}', encodeURIComponent(String(envID)))
            .replace('{' + 'resourceID' + '}', encodeURIComponent(String(resourceID)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'envID' is not null or undefined
        if (envID === null || envID === undefined) {
            throw new Error('Required parameter envID was null or undefined when calling readOneResource.');
        }

        // verify required parameter 'resourceID' is not null or undefined
        if (resourceID === null || resourceID === undefined) {
            throw new Error('Required parameter resourceID was null or undefined when calling readOneResource.');
        }
