...
export class ManagementAPIsResourcesResourcesApi {
    ...
    public async v1EnvironmentsEnvIDResourcesResourceIDGet (envID: string, resourceID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        // verify required parameter 'envID' is not null or undefined
        if (envID === null || envID === undefined) {
            throw new Error('Required parameter envID was null or undefined when calling v1EnvironmentsEnvIDResourcesResourceIDGet.');
        }

        // verify required parameter 'resourceID' is not null or undefined
        if (resourceID === null || resourceID === undefined) {
            throw new Error('Required parameter resourceID was null or undefined when calling v1EnvironmentsEnvIDResourcesResourceIDGet.');
        }
