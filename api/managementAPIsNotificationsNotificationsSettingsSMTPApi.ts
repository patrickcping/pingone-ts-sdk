...
export enum ManagementAPIsNotificationsNotificationsSettingsSMTPApiApiKeys {
}

export class ManagementAPIsNotificationsNotificationsSettingsSMTPApi {
    ...
    public setApiKey(key: ManagementAPIsNotificationsNotificationsSettingsSMTPApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsNotificationsNotificationsSettingsSMTPApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param envID 
     */
    public async v1EnvironmentsEnvIDNotificationsSettingsEmailDeliverySettingsGet (envID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        if (envID === null || envID === undefined) {
            throw new Error('Required parameter envID was null or undefined when calling v1EnvironmentsEnvIDNotificationsSettingsEmailDeliverySettingsGet.');
        }
