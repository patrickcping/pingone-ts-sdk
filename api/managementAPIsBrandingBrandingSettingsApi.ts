...
export enum ManagementAPIsBrandingBrandingSettingsApiApiKeys {
}

export class ManagementAPIsBrandingBrandingSettingsApi {
    ...
    public setApiKey(key: ManagementAPIsBrandingBrandingSettingsApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsBrandingBrandingSettingsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param authorization 
     */
    public async v1EnvironmentsEnvIDBrandingSettingsGet (envID: string, authorization?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        ...
        if (envID === null || envID === undefined) {
            throw new Error('Required parameter envID was null or undefined when calling v1EnvironmentsEnvIDBrandingSettingsGet.');
        }
