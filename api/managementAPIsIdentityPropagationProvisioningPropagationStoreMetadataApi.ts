...
export enum ManagementAPIsIdentityPropagationProvisioningPropagationStoreMetadataApiApiKeys {
}

export class ManagementAPIsIdentityPropagationProvisioningPropagationStoreMetadataApi {
    ...
    public setApiKey(key: ManagementAPIsIdentityPropagationProvisioningPropagationStoreMetadataApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsIdentityPropagationProvisioningPropagationStoreMetadataApiApiKeys[key]].apiKey = value;
    }
