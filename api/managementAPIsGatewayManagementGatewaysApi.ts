...
export enum ManagementAPIsGatewayManagementGatewaysApiApiKeys {
}

export class ManagementAPIsGatewayManagementGatewaysApi {
    ...
    public setApiKey(key: ManagementAPIsGatewayManagementGatewaysApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsGatewayManagementGatewaysApiApiKeys[key]].apiKey = value;
    }
