...
export enum ManagementAPIsGatewayManagementGatewayInstancesApiApiKeys {
}

export class ManagementAPIsGatewayManagementGatewayInstancesApi {
    ...
    public setApiKey(key: ManagementAPIsGatewayManagementGatewayInstancesApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsGatewayManagementGatewayInstancesApiApiKeys[key]].apiKey = value;
    }
