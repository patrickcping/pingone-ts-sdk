...
export class ManagementAPIsIdentityPropagationProvisioningPropagationRevisionsApi {
     ...
     * @param contentType 
     */
    public async v1EnvironmentsEnvIDPropagationRevisionsPost (envID: string, contentType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
