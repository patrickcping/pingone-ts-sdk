...
export enum ManagementAPIsRiskManagementRiskPoliciesApiApiKeys {
}

export class ManagementAPIsRiskManagementRiskPoliciesApi {
    ...
    public setApiKey(key: ManagementAPIsRiskManagementRiskPoliciesApiApiKeys, value: string) {
        (this.authentications as any)[ManagementAPIsRiskManagementRiskPoliciesApiApiKeys[key]].apiKey = value;
    }
